...
audio20 = fs.readFileSync('./X3/nayla20.m4a') 
		...
		//	if (nay.key.fromMe) return
            ...
            case 'sticker':  
         	...
         	.on('end', function () {
         	console.log('SELESAI JANGAN LUPA SUKSES')
			...
			reply('SUKSES!!!, JGN LUPA SUBSCRIBE https://youtube.com/channel/UC2LtH1iE9sXUhOvIvEgYBZw')
			} catch {
			reply('LINK ERROR!')
			}
			break			  	
...
// HAPUS? GW GA UP LAGI OKY 
            ...
            const menu2 = {contentText: menu3, buttons: menu1,headerType: 1}      
